                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="news-search-engine-type" colspan="3">
                                ...
                                <p class="description">This endpoint returns the subset of news publishers that top headlines are available from.</p>
                                </lable>
                                <lable>
                                ...
                                <p class="description">This endpoint provides live top and breaking headlines.</p>
                                </lable>
                            </td>                           
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="topHeadlines everything">
                                <input type="number" name="news-search-engine-page-size"  value="<?=  (sanitize_text_field( $_POST['news-search-engine-page-size'] )) ? esc_html($_POST['news-search-engine-page-size']) : get_option('news-search-engine-default-page-size'); ?>" max="100"/>
                            ...
                            <td class="topHeadlines everything">
                                <input type="number" name="news-search-engine-page" value="<?=  (sanitize_text_field( $_POST['news-search-engine-page'] )) ? esc_html($_POST['news-search-engine-page']) : '1' ?>" max="100"/>
